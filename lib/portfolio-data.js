export const PROFILE = {
  ...
  tagline: 'An ecommerce expert for over 12 years.',
  roles: ['Shopify Expert', 'Software Developer', 'UI/UX Designer'],
...
export const ABOUT = [
  "Hey there! I'm Logan, based in Miami, Florida, and my 12-year adventure in eCommerce has been nothing short of a wild ride.",
  'It started in customer service and sales at an online training company. Before I knew it, I was running the whole show — jazzing up the website with WooCommerce, throwing in automations, and even adding a Learning Management System.',
  'Then I joined an eCommerce agency, managing projects on WordPress, Shopify, WooCommerce, and BigCommerce — a digital playground. I got to brush up on design and programming skills, jumping in to help the team as a tech superhero.',
  'The real game-changer was a Miami food brand, where I took their eCommerce channel from $200 to $250,000/month across three channels in just two years.',
  "When COVID hit, I dove into freelancing full-time. The freedom, the excitement, the financial perks — it's got it all. I'm still riding the eCommerce wave, one gig at a time.",
]
