...
export default function HeroSection() {
  ...
  return (
    <section className="text-left relative py-20 bg-gray-900 overflow-hidden ">
      <Image
      ...
      <div className="relative z-10 px-5 md:px-10 ">
        ...
        <ul className=" opacity-0 animate-fade-in text-2xl md:text-4xl drop-shadow-[0_5px_5px_rgba(0,0,0,0.95)] text-white  uppercase">
          <li className="pl-2">Shopify Expert</li>
          <li className="pl-6">Full Stack Developer</li>
          <li className="pl-12">UI/UX Designer</li>
        </ul>
        <p className=" opacity-0 animate-fade-in text-xl drop-shadow-[0_5px_5px_rgba(0,0,0,0.95)] text-white mb-8">
